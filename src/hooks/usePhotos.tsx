...
function usePhotos(stage: Stage, groupId?: GroupId, slug?: string, unsure?: boolean, reduceByFn?: (item: TaxonPhoto) => any) {
    ...
    switch (stage) {
        ...
        case 'egg': throw new Error('Stage egg not implemented')
    }
}
